...
parser.add_argument('--llm_model', type=str, required=True, default='GPT2',
...
parser.add_argument('--freq', type=str, default='h',
                    help='freq for time features encoding, '
                         'options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly, mi:minutely], '
...
for ii in range(args.itr):
    ...
    train_loader, vali_loader, test_loader, Time_LLM_model, time_llm_model_optim, scheduler = accelerator.prepare(
        train_loader, vali_loader, test_loader, Time_LLM_model, time_llm_model_optim, scheduler)
    if args.use_amp:
